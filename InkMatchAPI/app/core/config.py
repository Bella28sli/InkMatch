...
class Settings(BaseSettings):
    ...
    unisender_api_key: str | None = Field(default=None, validation_alias='UNISENDER_API_KEY')
    unisender_sender_email: str | None = Field(default=None, validation_alias='UNISENDER_SENDER_EMAIL')
    unisender_sender_name: str = Field(default='InkMatch', validation_alias='UNISENDER_SENDER_NAME')
    unisender_api_base_url: str = Field(default='https://api.unisender.com/ru/api', validation_alias='UNISENDER_API_BASE_URL')
    gmail_token_path: str = Field(default='gmail_token.json', validation_alias='GMAIL_TOKEN_PATH')
